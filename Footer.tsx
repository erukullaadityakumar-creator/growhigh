  ...
  return (
    <footer className="bg-brand-dark pt-24 pb-12 border-t border-brand-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Final CTA */}
        <div className="relative rounded-2xl p-8 md:p-16 text-center overflow-hidden mb-24 border border-brand-border bg-brand-card">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4 mt-8 md:mt-0">
            <a href="https://www.instagram.com/adityacharan_2011/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-brand-border flex items-center justify-center text-text-muted hover:text-white hover:bg-brand-primary transition-all">
            ...
            <a href="https://www.linkedin.com/in/aditya-charan-erukulla-494993371" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-brand-border flex items-center justify-center text-text-muted hover:text-white hover:bg-brand-primary transition-all">
              <Linkedin className="w-4 h-4" />
            </a>
            <a href="mailto:erukullaadityakumar@gmail.com" className="w-10 h-10 rounded-full bg-brand-border flex items-center justify-center text-text-muted hover:text-white hover:bg-brand-primary transition-all">
