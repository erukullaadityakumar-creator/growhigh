      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="overflow-hidden rounded-xl border border-brand-border bg-brand-card">
          ...
          {[
            ...
            <div key={i} className={`grid grid-cols-12 items-center py-5 px-6 ${i !== 4 ? 'border-b border-brand-border/50' : ''} hover:bg-brand-hover hover:border-brand-primary/30 transition-all duration-300 group`}>
