    ...
    <section className="py-24 bg-brand-card/20 border-y border-brand-border">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 font-display animate-blur-in">The difference between a vendor and a partner</h2>
          <p className="text-text-body text-lg animate-slide-up" style={{ animationDelay: '0.2s' }}>See how we stack up against generic AI agencies.</p>
        </div>
        ...
        <div className="overflow-hidden rounded-xl border border-brand-border bg-brand-card">
          ...
          {[
            ...
            <div key={i} className={`grid grid-cols-12 items-center py-5 px-6 ${i !== 4 ? 'border-b border-brand-border/50' : ''} hover:bg-brand-hover hover:border-brand-primary/30 transition-all duration-300 group hover:animate-glow-border`} style={{ animation: `slideRight 0.6s ease-out forwards`, animationDelay: `${i * 60}ms` }}>
              <div className="col-span-4 md:col-span-5 text-sm font-bold text-white pr-4">{row.feature}</div>
              
              <div className="col-span-4 md:col-span-3 flex flex-col items-center justify-center text-center group-hover:animate-shake">
              ...
              <div className="col-span-4 flex flex-col items-center justify-center text-center">
                <div className="w-6 h-6 rounded-full bg-brand-primary/20 flex items-center justify-center mb-1 group-hover:animate-pulse-subtle">
                   <Check className="w-4 h-4 text-brand-primary group-hover:animate-scale-up" />
                </div>
